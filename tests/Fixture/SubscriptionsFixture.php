...
class SubscriptionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_type' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-19 16:02:14',
                'modified' => '2018-07-19 16:02:14'
            ],
        ];
        parent::init();
    }
