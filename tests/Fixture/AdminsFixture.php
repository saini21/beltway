...
class AdminsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'profile_image' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-05 01:38:14',
                'modified' => '2018-07-05 01:38:14'
            ],
        ];
        parent::init();
    }
