...
class ArticleCommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'article_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'status' => 1,
                'created' => '2018-06-10 02:22:21',
                'modified' => '2018-06-10 02:22:21'
            ],
        ];
        parent::init();
    }
