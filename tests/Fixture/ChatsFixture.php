...
class ChatsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'no_of_members' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'no_of_members' => 1,
                'created' => '2018-07-21 11:41:49',
                'modified' => '2018-07-21 11:41:49'
            ],
        ];
        parent::init();
    }
