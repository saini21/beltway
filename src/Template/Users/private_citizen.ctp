 ...
 */
?>
<?php $this->assign('title', __('Private Citizen')); ?>
...
">
                    <input type="text" name="return" id="returnUrl"
                           value="<?= SITE_URL ?>/users/private-citizen-api/?uid=<?= $authUser['id']; ?>&type=Citizen">
                    <div class="form-group">
                        <h5> Member Status </h5>
                    </div>
                    <div class="form-group">
                        <div class="radio radio-danger vikas">
                            <input type="radio" class="user_type" name="os0" id="radio20" value="Citizen" checked="checked">
                            ...
                            <p><span class="icon-a"><i class="fa fa-caret-right" aria-hidden="true"></i></span> Comment
                                ...
                                $0.99/month</p>
                            <br>
                            <input type="radio" class="user_type" name="os0" id="radio21" value="Activist">
