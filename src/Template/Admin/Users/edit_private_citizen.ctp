<div class="users form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Private Citizen') ?></legend>
        <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 ">
            ...
            <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'privateCitizens']) ?>" class="btn btn-danger" style="float: left; margin-left: 20px;">Cancel</a>
        </div>
    </div>
    <?= $this->Form->end() ?>
</div>
