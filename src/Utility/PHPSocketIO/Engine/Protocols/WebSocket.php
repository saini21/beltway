...
use \App\Utility\PHPSocketIO\Engine\Protocols\WebSocket\RFC6455;
use \App\Utility\Workerman\Connection\TcpConnection;
...
class WebSocket {
    ...
    public static function dealHandshake($connection, $req, $res) {
        ...
        $connection->protocol = 'App\Utility\PHPSocketIO\Engine\Protocols\WebSocket\RFC6455';
