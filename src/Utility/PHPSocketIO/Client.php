...
use App\Utility\PHPSocketIO\Parser\Parser;
...
class Client {
    ...
    public function __construct($server, $conn) {
        $this->server = $server;
        $this->conn = $conn;
        $this->encoder = new \App\Utility\PHPSocketIO\Parser\Encoder();
        $this->decoder = new \App\Utility\PHPSocketIO\Parser\Decoder();
        $this->id = $conn->id;
